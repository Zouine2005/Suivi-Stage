          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                  <a class="nav-link active" href="#"
                      style="font-size: 25px; font-family:Georgia, 'Times New Roman', Times, serif;margin-right:50px">Dashbord</a>
              </li>
              ...
              <div class="container-fluid">
                  <a class="navbar-brand position-absolute top-0 end-0" href="{{ route('directeur.profile') }}">
                      <img src="{{asset('images/directrice.png')}}" alt="Avatar Logo" style="width:60px;margin-top:10px"
                          class="rounded-pill">
                  </a>
              </div>
          </ul>
